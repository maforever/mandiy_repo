...
public class ChoosePosterModelActivity extends Activity {
	private String type;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.choose_poster_model);
		try {
...
//		Log.i("a", "model size = " + cardModelIds.size());
	...
	public class OnItemClickListenerImpl implements OnItemClickListener {
		public void onItemClick(AdapterView<?> adapterView, View view, int postion,long id) {
			...
			Intent intent = new Intent(ChoosePosterModelActivity.this, SelectPicActivity.class);
...
//				Log.i("a", "selectedCardModelIds size = " + selectedCardModelIds.size());
			...
			ChoosePosterModelActivity.this.finish();
	...
	public void btnClick(View view) {
		ChoosePosterModelActivity.this.finish();
		Intent intent = new Intent(ChoosePosterModelActivity.this, IndexActivity.class);
		startActivity(intent);
	}
}

...
//        parameters.add(new BasicNameValuePair("openid",  openid));
	...
	public String toString() {
		return "OAuth [seqid=" + seqid + ", clientIP=" + clientIP
				+ ", appFrom=" + appFrom + ", openid=" + openid + ", openkey="
				+ openkey + ", oauthVersion=" + oauthVersion + ", scope="
				+ scope + ", status=" + status + ", msg=" + msg + ", random="
				+ random + "]";
	}
